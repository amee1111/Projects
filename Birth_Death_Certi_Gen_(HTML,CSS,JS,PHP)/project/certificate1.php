...
<body>
	<form action="1.html">
	<div class="div">
		<h5 class="ch1">Reg. no:<?php echo $_SESSION['regid']?></h5>
		...
		<h4 style="text-align: center;"><?php echo $_SESSION['bname']." (".$_SESSION['gn'].")";?></h4>
		<hr class="chr1">
		<h4 style="text-align: center;font-family: serif;">was born to</h4>
		<h4 class="ch2"><?php echo $_SESSION['father']?></h4> 
		<h4 style="text-align: center; font-family: serif;">and</h4>
		<h4 class="ch3"><?php echo $_SESSION['mother']?></h4>
		<hr class="chr2">
		<hr class="chr3">
		<h4 style="text-align: center;font-family: serif;">on this</h4>
		<h4 style="text-align: center;"><?php echo $_SESSION['date']?></h4>
		<hr class="chr4">
		...
		<h4 class="ch7">at</h4>
		<h4 class="ch8"><?php echo $_SESSION['hospital']?></h4>
